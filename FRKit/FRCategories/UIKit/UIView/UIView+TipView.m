...
{
    [self setAssociatedObject:__tt_tipview_userData forKey:@"__tt_tipview_userData" association:FRAssociationStrong isAtomic:NO];
}
...
{
    [self setAssociatedObject:__tt_tipview_retryAction forKey:@"__tt_tipview_retryAction" association:FRAssociationStrong isAtomic:NO];
}
...
{
    [self setAssociatedObject:tt_tipView forKey:@"__tt_tipView" association:FRAssociationStrong isAtomic:NO];
}
- (UIView *)tt_tipView
{
